...
function dateToString(date) {
    ...
    if (date.day < 10) {
        dateStr.day = "0" + date.day;  // when adding to a string it automatically type cast
    } 
    else {
...
function getAllDateFormats(date) {
    ...
    var mmddyy = dateStr.month + dateStr.day + dateStr.year.slice(-2); // slice return last n digits
...
function getNextDate(date) {
    ...
    var daysInMonth = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31]; // array to map
